...
bool DeleteMe(BiTree biTree, BiNode *e) {
    queue<BiNode *> queue1;
    queue1.push(biTree);
    BiNode *biNode;
    biNode = queue1.front();
...
bool Delete(BiTree biTree, BiNode *e) {
    queue<BiNode *> queue1;
    queue1.push(biTree);
    BiNode *biNode;
    biNode = queue1.front();
    ...
    while (biNode != NULL) {
        ...
        if (biNode == e) {
            ...
            if (pre->lchild == biNode) {
                pre->lchild = NULL;
            }
            if (pre->rchild == biNode) {
                pre->rchild = NULL;
            }
